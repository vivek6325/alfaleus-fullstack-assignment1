...
import { DndContext, useSensor, useSensors, PointerSensor, KeyboardSensor, useDroppable } from '@dnd-kit/core';
import Card from './Card.jsx';
import { Plus, X, ListTodo, Play, CheckCircle } from 'lucide-react';
...
export default function KanbanBoard({ board, onCardMove, onCardCreate, onCardUpdate, onCardDelete }) {
  ...
  // Set up dnd-kit sensors with Pointer activation constraint to prevent issues with button clicks
  ...
  const handleDragEnd = (event) => {
    ...
    // Find the card being dragged and update status if it changed
        ...
        {board.columns.map((col) => {
          ...
          return (
            <BoardColumn
              ...
              setNewComplexity={setNewComplexity}
